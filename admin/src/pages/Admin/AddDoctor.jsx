  ...
  return (
    <form onSubmit={handleSubmit} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          <label htmlFor="doctor-image">
            <img
              ...
              alt=""
            />{" "}
            {/* A url will be created if docimage is present to be shown on the UI. */}
          </label>
          <input
          ...
          <div className="w-full flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              >
                ...
                <option value="Gastroenterologist">Gastroentorologist</option>
              </select>
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <p>Doctor's Education</p>
              <input
        ...
        <div className="flex-1 flex flex-col gap-1">
          <p className="mt-4 mb-2">Doctor's About</p>
          <textarea
